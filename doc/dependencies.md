...
These are the dependencies currently used by Ion Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| XCB |  |  |  |  | [Yes](https://github.com/ioncoincore/ion/blob/master/depends/packages/qt.mk#L87) (Linux only) |
