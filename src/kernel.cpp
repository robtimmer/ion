                ...
                unsigned int nTimeBlockFrom, unsigned int& nTimeTx, uint256& hashProofOfStake)
{
    ...
    if (chainActive.Height() >= Params().DGWStartHeight()) {
        ...
        ss << nTimeBlockFrom << hashProofOfStake << nValueIn << nTimeTx;
    }
...
bool Stake(CStakeInput* stakeInput, unsigned int nBits, unsigned int nTimeBlockFrom, unsigned int& nTimeTx, uint256& hashProofOfStake)
{
    ...
    if (nHeightStart < Params().DGWStartHeight())
        ssUniqueID << nStakeModifier;
...
bool CheckProofOfStake(const CBlock block, uint256& hashProofOfStake, std::unique_ptr<CStakeInput>& stake, int nHeight)
{
    ...
    if (tx.IsZerocoinSpend()) {
        ...
        stake = std::unique_ptr<CStakeInput>(ionInput);
    }
    ...
    // CEVAP: **TODO** - CheckProofOfStake not working
