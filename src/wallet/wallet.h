...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that xionspends need to use the cs_spendcache
...
public:
    ...
    // Get only ION transaction amounts
