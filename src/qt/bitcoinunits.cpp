...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ION:
            return QString("tION");
        case mION:
            return QString("mtION");
        case uION:
            return QString::fromUtf8("μtION");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ION:
            return QString("ION");
        case mION:
            return QString("Milli-ION (1 / 1" THIN_SP_UTF8 "000)");
        case uION:
            return QString("Micro-ION (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case ION:
            return QString("TestIONs");
        case mION:
            return QString("Milli-TestION (1 / 1" THIN_SP_UTF8 "000)");
        case uION:
            return QString("Micro-TestION (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
