...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), "ioncoin.conf"));
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), "iond.pid"));
#endif
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                // ION: load previous sessions sporks if we have them.
